use ratatui::{
    widgets::{Block, Paragraph, Widget, Wrap, StatefulWidget},
};
...
impl<'a> Widget for MarkdownViewer<'a> {
    fn render(self, area: ratatui::layout::Rect, buf: &mut ratatui::buffer::Buffer) {
        ...
        // Calculate inner area (account for block borders)
        ...
        // Calculate visual line count (wrapped lines)
        ...
        for line in &text.lines {
            ...
            if w == 0 {
                ...
                visual_lines += (w + inner_area.width - 1) / inner_area.width;
            }
        }

        // Clamp scroll to valid range
        let max_scroll = visual_lines.saturating_sub(inner_area.height) as u16;
